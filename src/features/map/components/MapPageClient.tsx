    ...
    <div className="flex flex-col h-[calc(100vh-53px)]">
      ...
      <div className="flex items-center gap-3 px-4 py-2.5 bg-white border-b border-slate-200 shrink-0">
        ...
        <div className="relative flex-1 max-w-sm">
          <input
            ...
            className="w-full text-sm border border-slate-300 rounded-lg px-3 py-1.5 pr-8 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          {searchLoading && (
          ...
          {showSearchResults && searchResults.length > 0 && (
            <ul className="absolute z-50 top-full mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-lg overflow-hidden">
              {searchResults.map((r) => (
                <li key={r.place_id}>
                  <button
                    className="w-full text-left text-sm px-3 py-2 hover:bg-indigo-50 truncate"
        ...
        <div className="flex items-center gap-2">
          {drawMode === "idle" ? (
            <button
              ...
              className="text-sm font-medium px-3 py-1.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition-colors flex items-center gap-1.5"
            >
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-indigo-700 font-medium bg-indigo-50 px-3 py-1.5 rounded-lg">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          />
          {/* Attribution helper */}
          <div className="absolute bottom-6 left-2 text-[10px] text-slate-400 pointer-events-none">
