      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-80 shrink-0 bg-white border-r border-sand flex flex-col overflow-y-auto">
          <div className="px-5 py-4 border-b border-sand">
            <h2 className="font-semibold text-navy">Personalise your letter</h2>
        ...
        {/* Right: preview */}
        <main className="flex-1 overflow-y-auto bg-cream px-6 py-6">
          <LetterPreview
            content={
              draft ?? {
          ...
          />
          <p className="text-xs text-navy-soft/70 text-center mt-4">
